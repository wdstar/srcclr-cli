...
func (o *GetLicenseUsingGETReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetLicenseUsingGETOK()
...
func (o *GetLicenseUsingGETOK) Error() string {
	return fmt.Sprintf("[GET /v3/licenses/{id}][%d] getLicenseUsingGETOK  %+v", 200, o.Payload)
}

func (o *GetLicenseUsingGETOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
