...
func (o *GetScanUsingGETOK) Error() string {
	return fmt.Sprintf("[GET /v3/scans/{id}][%d] getScanUsingGETOK  %+v", 200, o.Payload)
}

func (o *GetScanUsingGETOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
