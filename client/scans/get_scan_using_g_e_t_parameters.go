...
// NewGetScanUsingGETParams creates a new GetScanUsingGETParams object
// with the default values initialized.
func NewGetScanUsingGETParams() *GetScanUsingGETParams {
	var ()
	return &GetScanUsingGETParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetScanUsingGETParamsWithTimeout creates a new GetScanUsingGETParams object
...
// NewGetScanUsingGETParamsWithContext creates a new GetScanUsingGETParams object
...
// NewGetScanUsingGETParamsWithHTTPClient creates a new GetScanUsingGETParams object
...
/*GetScanUsingGETParams contains all the parameters to send to the API endpoint
for the get scan using g e t operation typically these are written to a http.Request
*/
...
func (o *GetScanUsingGETParams) WithContext(ctx context.Context) *GetScanUsingGETParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetScanUsingGETParams) WithID(id strfmt.UUID) *GetScanUsingGETParams {
	o.SetID(id)
	return o
}
