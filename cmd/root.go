...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.srcclr-cli.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".srcclr-cli" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".srcclr-cli")
	}
