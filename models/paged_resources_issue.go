...
// PagedResourcesIssue PagedResources«Issue»
// swagger:model PagedResources«Issue»
...
// Validate validates this paged resources issue
func (m *PagedResourcesIssue) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PagedResourcesIssue) validateEmbedded(formats strfmt.Registry) error {
...
func (m *PagedResourcesIssue) validateLinks(formats strfmt.Registry) error {
...
func (m *PagedResourcesIssue) validatePage(formats strfmt.Registry) error {
