...
// PagedResourcesWorkspace PagedResources«Workspace»
// swagger:model PagedResources«Workspace»
...
// Validate validates this paged resources workspace
func (m *PagedResourcesWorkspace) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PagedResourcesWorkspace) validateEmbedded(formats strfmt.Registry) error {
...
func (m *PagedResourcesWorkspace) validateLinks(formats strfmt.Registry) error {
...
func (m *PagedResourcesWorkspace) validatePage(formats strfmt.Registry) error {
...
func (m *PagedResourcesWorkspace) UnmarshalBinary(b []byte) error {
	var res PagedResourcesWorkspace
